...
import com.minispring.aop.core.AfterReturningAdvice;
import com.minispring.aop.core.MethodBeforeAdvice;
import com.minispring.aop.support.AdvisedSupport;
...
public class JdkDynamicAopProxy implements AopProxy, InvocationHandler {
    ...
    private static class AopMethodInvocation extends ReflectiveMethodInvocation {
        ...
        public Object proceed() throws Throwable {
            ...
            // 处理不同类型的通知
            if (interceptorOrAdvice instanceof MethodBeforeAdvice beforeAdvice) {
                System.out.println("Executing before advice");
                beforeAdvice.before(getMethod(), getArguments(), getThis());
                return proceed();
            } else if (interceptorOrAdvice instanceof AfterReturningAdvice afterAdvice) {
