package com.minispring.ioc.support;

import com.minispring.beans.*;
import com.minispring.beans.factory.config.BeanReference;
import com.minispring.beans.factory.support.DisposableBeanAdapter;
...
import com.minispring.ioc.instantiation.ConstructorResolver;
import com.minispring.ioc.instantiation.InstantiationStrategy;
import com.minispring.ioc.instantiation.SimpleInstantiationStrategy;
import com.minispring.ioc.lifecycle.BeanPostProcessor;
import com.minispring.ioc.lifecycle.DisposableBean;
import com.minispring.ioc.lifecycle.InitializingBean;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory {
    ...
    protected Object createBeanInstance(BeanDefinition beanDefinition, String beanName, Object[] args) {
        ...
        // 解析构造函数和参数
        ConstructorResolver.BeanInstantiationContext instantiationContext = constructorResolver.autowireConstructor(
